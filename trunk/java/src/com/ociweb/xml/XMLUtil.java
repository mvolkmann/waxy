...
public class XMLUtil {
    ...
    public static final String BASE_CHAR_PATTERN =
    ...
    public static final String COMBINING_CHAR_PATTERN =
    ...
    public static final String DIGIT_PATTERN =
    ...
    public static final String EXTENDER_PATTERN =
        "#x00B7|#x02D0|#x02D1|#x0387|#x0640|#x0E46|#x0EC6|#x3005|" +
        "[#x3031-#x3035]|[#x309D-#x309E]|[#x30FC-#x30FE]";
  
    public static final String IDEOGRAPHIC_PATTERN =
     ...
     */
    public static final Pattern LATIN_NMTOKEN_PATTERN =
    ...
    //    Pattern.compile("(" + NAME_CHAR_PATTERN + ")+");
    ...
    public static boolean isNMToken(String text) {
        ...
        if (LATIN_NMTOKEN_PATTERN.matcher(text).matches()) return true;

        // Since that didn't match, try the full regular expression.
        return false; //NMTOKEN_PATTERN.matcher(text).matches();
    }
